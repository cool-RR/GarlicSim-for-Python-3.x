...
import garlicsim_py3.misc.history_browser
...
class HistoryBrowser(garlicsim_py3.misc.history_browser.HistoryBrowser):
    '''
    ...
    def get_state_by_monotonic_function(self, function, value,
        ...
        See documentation of garlicsim_py3.general_misc.binary_search.binary_search
