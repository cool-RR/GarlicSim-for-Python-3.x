...
class Project(object):
    ...
    def __init__(self, simpack):
        ...
        wrapped_simpack = \
            garlicsim_py3.general_misc.module_wrapper.module_wrapper_factory \
            (simpack)
        
        self.simpack = wrapped_simpack
        
        self.simpack_grokker = \
            garlicsim_py3.misc.simpack_grokker.SimpackGrokker(wrapped_simpack)        

        self.tree = garlicsim_py3.data_structures.Tree()
        
        self.crunching_manager = CrunchingManager(self)
        
        self.tree_lock = garlicsim_py3.general_misc.read_write_lock.ReadWriteLock()
        '''
