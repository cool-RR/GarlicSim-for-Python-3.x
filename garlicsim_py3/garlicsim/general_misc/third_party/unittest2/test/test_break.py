...
@unittest2.skipUnless(hasattr(os, 'kill'), "Test requires os.kill")
@unittest2.skipIf(sys.platform =="win32", "Test cannot run on Windows")
@unittest2.skipIf(sys.platform == 'freebsd6', "Test kills regrtest on freebsd6 "
